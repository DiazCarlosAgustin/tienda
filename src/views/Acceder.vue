        ...
        <div class="col-12 col-md-6 col-lg-4 form">
            <b-form @submit.prevent="login">
                ...
                <b-form-group class="w-100 text-center"> 
                    <router-link class="btn btn-light w-100 btn-md btn-link"  to="/registrarse">No tengo una cuenta</router-link>
                </b-form-group>
                <b-form-group class="w-100 text-center">
                    <b-button type="submit" class="btn btn-md w-100 _btn-dark" >Aceptar</b-button>
                </b-form-group>
            </b-form>
        </div>
    </div>
